    ...
    */
    ...
    <div class="offcanvas-body">
        ...
        <div class="collapse show" id="collapseExample">
            ...
            <section class="element template" data-type="horizontal" draggable="true">
            ...
            <section class="element template" data-type="vertical" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
            ...
            <section class="element template" data-type="grid" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
        ...
        <div>
            <a data-bs-toggle="collapse" href="#collapseElements" role="button" aria-expanded="true" aria-controls="collapseElements">
                Elements
            </a>
        </div>
        <div class="collapse show" id="collapseElements">
            <article class="element template" data-type="html" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
            ...
            <article class="element template" data-type="markdown" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
            ...
            <article class="element template" data-type="balde" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
            ...
            <article class="element template" data-type="text" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
            ...
            <article class="element template" data-type="chart" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
            ...
            <article class="element template" data-type="list" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
            ...
            <article class="element template" data-type="heading" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
            ...
            <article class="element template" data-type="button" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
        ...
        <div>
            <a data-bs-toggle="collapse" href="#collapseMedia" role="button" aria-expanded="true" aria-controls="collapseMedia">
                Media
            </a>
        </div>
        <div class="collapse show" id="collapseMedia">

            <article class="element template" data-type="image" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
            ...
            <article class="element template" data-type="video" draggable="true">
                <article class="flex items-center p-2 bg-white">
                    <div class="">
            ...
            <article class="element template" data-type="music" draggable="true">
                <div class="flex items-center p-2 bg-white">
                    <div class="">
        ...
        <article class="element template" data-type="block" data-url="/api/pages/block/title" draggable="true">
            <div class="flex items-center p-2 bg-white">
                <div class="">
        ...
        <article class="element template" data-type="block" data-url="https://jinytheme.github.io/widgets/hero1.html" draggable="true">
            <div class="flex items-center p-2 bg-white">
                <div class="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-square" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M15 2a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2zM0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2zm8.5 2.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V4.5z"/>
