<div>
    ...
    <!-- 팝업창 -->
    @if ($popupForm)
        @includeIf("jiny-site-page::design.popup")
    @endif
            ...
            widgets.forEach(element => {
                ...
                element.addEventListener('drop', function(e) {
                    ...
                    if (dragSource.dataset.pos > dragTarget.dataset.pos) {
                        ...
                        // 요소이동
                        dragTarget.parentElement.insertBefore(dragSource, dragTarget.nextElementSibling);

                        let prev; // 상위요소를 하나씩 이동
                        prev = dragSource.previousElementSibling;
                        while(prev && prev.id == "widget") {
                            console.log(prev);
                            dragTarget.parentElement.insertBefore(prev, prev.previousElementSibling);
