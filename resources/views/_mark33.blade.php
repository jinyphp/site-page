    ...
    <x-theme-layout>
        ...
        <form class="desgin">
            @if (is_array($slot))
                ...
                @foreach ($slot as $i => $item)
                    ...
                    <div class="el-block margin-box">
                        <section class="mb-4 padding-box element" data-pos="{{$i}}" data-path="{{$item->path}}" data-id="{{$item->id}}">
                            <div class="inner">
                                <div class="widget">
        ...
        <script>
            ...
            mainDesign.addEventListener("mouseover", function( e ) {
                if(e.target.classList.contains('el-block')) {
                    if(hover != e.target) {
                        if(hover) {
        ...
        <div class="design">
            ...
            <button class="side-panel-toggle" type="button">
                <span class="material-icons sp-icon-open">
        ...
        <script>
            document.querySelector(".side-panel-toggle").addEventListener("click", () => {
                document.querySelector(".design").classList.toggle("side-panel-open");
            });
        </script>
