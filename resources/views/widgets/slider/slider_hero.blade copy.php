		...
		<div class="container">
			...
			<div class="col-md-6 col-lg-5 d-flex flex-column">
				...
				<div class="d-flex justify-content-center justify-content-md-start pb-4 pb-xl-5 mt-n1 mt-md-auto mb-md-3 mb-lg-4">
					<div class="swiper-pagination position-static w-auto pb-1" id="sliderBullets">
						...
						<div class="swiper position-absolute top-0 start-0 w-100 h-100 user-select-none" id="heroImages" data-swiper='{
							...
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<img src="/assets/img/home/fashion/v1/hero-slider/01.png"
										class="rtl-flip" alt="Image">
								</div>
								<div class="swiper-slide">
									<img src="/assets/img/home/fashion/v1/hero-slider/02.png"
										class="rtl-flip" alt="Image">
								</div>
								<div class="swiper-slide">
									<img src="/assets/img/home/fashion/v1/hero-slider/03.png"
										class="rtl-flip" alt="Image">
								</div>
							</div>
						</div>
